...
export function removeElementFromHtml(source, target) {
    ...
    for (const op of operations) {
        switch (op.type) {
            ...
            case "attribute":
                ...
                break;
            case "html-attribute":
                if (!isAllowedHtmlAttribute(op.property))
                    break;
                if (op.value != null) {
                    if (!isSafeAttributeValue(op.property, op.value))
                        break;
            ...
            case "text-content":
                if (op.value != null)
                    htmlEl.textContent = op.value;
                break;
        }
    }
    return wrappedFragment ? document.body.innerHTML || "" : document.toString();
}
export function probeElementInSource(source, target) {
