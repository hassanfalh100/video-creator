...
export function registerThumbnailRoutes(api, adapter) {
    api.get("/projects/:id/thumbnail/*", async (c) => {
        ...
        const selectorIndex = Number.isFinite(rawSelectorIndex) && rawSelectorIndex > 0 ? rawSelectorIndex : undefined;
        ...
        try {
            ...
            if (!buffer) {
                return c.json({ error: "Thumbnail generation failed — Chrome browser may not be available" }, 500);
            }
