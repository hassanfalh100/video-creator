...
export const adapterRules = [
    ...
    ({ scripts }) => {
        ...
        const hasThreeImportMap = allScriptTexts.some((t) => /["']three["']/.test(t) &&
            /importmap/.test(scripts.find((s) => s.content === t)?.attrs || ""));
        const hasThreeModuleImport = allScriptTexts.some((t) => /\bimport\b.*['"]three['"]/.test(t) || /\bfrom\s+['"]three['"]/.test(t));
